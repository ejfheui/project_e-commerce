            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form action="<?= base_url('ChangePasswordSeller/change_password_seller'); ?>" method="post">
                            <div class="form-group">
                                <label for="current_password" class="m-0 font-weight-bold text-secondary">Current Password</label>
                                <input type="password" class="form-control mt-2" id="current_password" name="current_password" placeholder="Password sebelumnya">
                                <?= form_error('current_password', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="new_password1" class="m-0 font-weight-bold text-secondary">New Password</label>
                                <input type="password" class="form-control mt-2" id="new_password1" name="new_password1" placeholder="Password baru">
                                <?= form_error('new_password1', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="new_password2" class="m-0 font-weight-bold text-secondary">Repeat Password</label>
                                <input type="password" class="form-control mt-2" id="new_password2" name="new_password2" placeholder="konfirmasi password">
